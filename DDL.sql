...
(
  `team_id`        varchar(36) NOT NULL,
  `publish_task`   smallint(6) NOT NULL DEFAULT '5' COMMENT '学生发布的任务通过',
  `praise`         smallint(6) NOT NULL DEFAULT '1' COMMENT '点赞',
  `pay_for_answer` smallint(6) NOT NULL DEFAULT '-2' COMMENT '付费查看解读',
  `initial_score`  smallint(6) NOT NULL DEFAULT '20' COMMENT '初始积分',
  PRIMARY KEY (`team_id`),
